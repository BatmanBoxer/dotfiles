set --export POSH_THEME '/home/batmanboxer/.poshthemes/catppuccin.omp.json'
set --export POSH_SHELL_VERSION $FISH_VERSION
set --export POWERLINE_COMMAND oh-my-posh
set --export POSH_SESSION_ID 'd99a42f9-9249-44bc-b7e8-f491bb19733e'
...
set --global _omp_executable '/usr/local/bin/oh-my-posh'
